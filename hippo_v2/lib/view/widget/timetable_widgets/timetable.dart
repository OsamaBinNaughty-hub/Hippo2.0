...
import 'package:hippo_v2/view/widget/timetable_widgets/cell.dart';
import 'package:hippo_v2/view/widget/timetable_widgets/header.dart';
import 'package:hippo_v2/view/widget/timetable_widgets/time_indicator.dart';
import 'package:hippo_v2/view/widget/timetable_widgets/weekly_times.dart';
        ...
        Expanded(
          child: ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              ...
              children.add(TimeIndicator(WeeklyTimes.times[this.locale]![index]));
              children.addAll(
                List.generate(
